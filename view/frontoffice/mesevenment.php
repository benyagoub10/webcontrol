...
$fav = $evenementC->readp($_SESSION['id']);
if (isset($_GET['del'])) {
	$evenementC = new evenementC();
	$evenementC->deletep();
}
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li><a href="evenments.php">evenements</a></li>
								<li><a href="mesevenment.php">mes evenment</a></li>
				...
				foreach ($fav as $fv) {
					...
					<div class="col-lg-4 col-md-6 text-center <?php
						...
						<div class="single-product-item" style="background-color: grey;">
							...
							<a href="?del=<?= $fv['id'] ?>" class="cart-btn"><i class="fas fa-minus"></i>Retirer participation</a>
						</div>
					</div>
				<?php
				}
