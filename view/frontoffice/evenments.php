					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="mesevenment.php">mes evenments</a></li>
				...
				?>
					<div class="col-lg-4 col-md-6 text-center <?php
						...
						<div class="single-product-item" style="background-color: grey;">
							...
							<a href="?par&&f=<?= $f['id'] ?>&&u=<?= $_SESSION['id'] ?>" class="cart-btn"><i class="fas fa-plus"></i>Participer</a>
						</div>
					</div>
				<?php
				}
