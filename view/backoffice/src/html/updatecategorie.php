...
// create categorie
$id = $_GET['update'];
$categorie = $categorieC->findone($id);
if (
  isset($_POST["nom"])
) {
  if (
    ...
    $categorieC->update($categorie, $id);
  } else
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebarcategorie="full" data-sidebar-position="fixed" data-header-position="fixed">
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="card-body">
              <h5 class="card-title mt-5 fw-semibold mb-4">modifier une categorie</h5>
              <div class="mt-5 card">
                <div class="card-body">
                  <form action="" id="formr" method="post">
                    <div class="mb-3">
                      <label class="form-label">Nom :</label>
                      <input categorie="text" class="form-control" value="<?= $categorie['nom'] ?>" id="nom" name="nom">
                      <span id="nomr"></span>
                    </div>
                    <button categorie="submit" class="btn btn-primary">Submit</button>
                  </form>
                </div>
              </div>
            </div>
